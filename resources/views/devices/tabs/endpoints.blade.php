...
<div class="mb-6 border-b border-purple-500/20" x-data="{ activeSubTab: 'sources' }">
    <nav class="flex gap-6">
        <button @click="activeSubTab = 'sources'" :class="activeSubTab === 'sources' ? 'border-b-2 border-blue-400 text-blue-400' : 'text-purple-300/60 hover:text-purple-300'" class="pb-2 text-sm font-medium transition-colors flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16l-4-4m0 0l4-4m-4 4h18"/>
            </svg>
            Sources
        </button>
        <button @click="activeSubTab = 'destinations'" :class="activeSubTab === 'destinations' ? 'border-b-2 border-emerald-400 text-emerald-400' : 'text-purple-300/60 hover:text-purple-300'" class="pb-2 text-sm font-medium transition-colors flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
            </svg>
            Destinations
        </button>
        <button @click="activeSubTab = 'as'" :class="activeSubTab === 'as' ? 'border-b-2 border-purple-400 text-purple-400' : 'text-purple-300/60 hover:text-purple-300'" class="pb-2 text-sm font-medium transition-colors flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="glass-card rounded-xl overflow-hidden">
            <table class="min-w-full">
                <thead class="bg-blue-500/10">
                    <tr>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Source IP</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Traffic</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider w-1/3">Distribution</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Flows</th>
                    </tr>
                </thead>
                    ...
                    <tr class="{{ $index % 2 === 0 ? 'bg-purple-500/5' : '' }} hover:bg-purple-500/10 transition-colors group">
                        ...
                        <td class="px-5 py-3">
                            <div class="flex items-center gap-3">
                                <div class="flex-1 h-2 bg-purple-500/10 rounded-full overflow-hidden">
                        ...
                        <td class="px-5 py-3 whitespace-nowrap text-sm text-purple-300/60">
        ...
        <div class="glass-card rounded-xl overflow-hidden">
            <table class="min-w-full">
                <thead class="bg-emerald-500/10">
                    <tr>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Destination IP</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Traffic</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider w-1/3">Distribution</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Flows</th>
                    </tr>
        ...
        <div class="glass-card rounded-xl overflow-hidden">
            <table class="min-w-full">
                <thead class="bg-purple-500/10">
                    <tr>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">AS Number</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Organization</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Country</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Sent</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Received</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-purple-300/70 uppercase tracking-wider">Flows</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-purple-500/10">
                    ...
                    <tr class="{{ $index % 2 === 0 ? 'bg-purple-500/5' : '' }} hover:bg-purple-500/10 transition-colors">
                        <td class="px-5 py-3 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs font-semibold rounded bg-purple-500/20 text-purple-300">
                                AS{{ $as['asn'] }}
                            </span>
                        </td>
